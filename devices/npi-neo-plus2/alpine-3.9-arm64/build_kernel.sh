...
CONFIG_BUILD_SALT="4.19.0-5-arm64"
...
CONFIG_SYSTEM_TRUSTED_KEYS="kernel_key.pem"
...
deps="bc bison curl flex gcc make musl-dev libressl libressl-dev linux-headers ncurses-dev xz"
kernel="linux-4.19.46"

apk -u add ${deps}

curl -LO https://cdn.kernel.org/pub/linux/kernel/v4.x/"${kernel}".tar.xz
